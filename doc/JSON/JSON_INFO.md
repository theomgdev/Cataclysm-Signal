...
| `trains_stats` | _(object)_ How much practising this skill contributes to `str`, `dex`, `int` or `per`. Weight 1.0 is a skill the stat is central to; a stat approaches, but never reaches, twice its base value. |
